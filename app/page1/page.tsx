...
const Page1 = () => {
  ...
  const myPosition = [
    ...
    {
      valutName: "Arbitrum Stability Vault",
    ...
    {
      valutName: "Avalanche Stability Vault",
    ...
    <div className=" space-y-6">
      ...
      >
        <div className="flex items-center gap-4">
          <Image src={avatar} alt="avatar" className=" w-[75px] h-[75px]" />
          <div className=" space-y-2">
            <h4 className=" text-t-18 font-bold text-white">My Profile</h4>
