        ...
        {tabIndex === 1 ? (
          <div className=" flex flex-col lg:flex-row items-center lg:justify-between">
            <div className="basis-[45%] space-y-5">
              ...
              The BTC.b Vault on Avalanche is designed to be a yield-bearing SAMS Vault comprised of 100% exposure to Bridged Bitcoin ($BTC.b). The avaBTC Vault accrues yield from Yield Yak, Delta Prime, and Benqi Finance.
              </p>
